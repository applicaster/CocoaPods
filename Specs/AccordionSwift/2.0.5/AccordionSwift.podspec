...
The best way of implement an accordion menu using an UITableView in Swift
  ...
  s.homepage         = 'https://github.com/applicaster/AccordionSwift'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Alex Zchut' => 'a.zchut@applicaster.com' }
  s.source           = { :git => 'https://github.com/applicaster/AccordionSwift.git', :tag => "v#{s.version.to_s}" }
  s.social_media_url = ''
  s.swift_version    = '5.0'
