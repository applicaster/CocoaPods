Pod::Spec.new do |s|
	...
	s.source = {
    	"http" => "https://assets-production.applicaster.com/zapp/helpers/sdks/ApplicasterUIKit/ApplicasterUIKit_Framework_8.1.3_4c500d078c523ba2b4ebaaec2be97ef667e0fbc9.zip"
	}
	s.xcconfig =  {
                'SWIFT_VERSION' => '5.1',
