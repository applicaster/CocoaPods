Pod::Spec.new do |s|
  ...
  s.summary      = "APCrossmates static library"
  ...
  s.source       = { 
                     :git => 'https://github.com/applicaster/Applicaster-Crossmates-Static-iOS.git',
                     :tag => s.version.to_s 
                    }
  s.source_files  = "Headers/**/*.h", "libAPCrossmates_Debug.a"  
