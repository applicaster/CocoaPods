Pod::Spec.new do |s|
  ...
  s.source = {
      "http" => "https://dl.bintray.com/applicaster-ltd/pods/ZappLoginPlugins_Framework_4.1.0_ef6e959711dab5314731d412105db9b065e85e09.zip"
  }
  ...
  s.subspec 'FacebookLogin' do |facebookLogin|
    ...
    facebookLogin.dependency 'ApplicasterSDK', '~> 7.1.0'
  ...
  s.subspec 'MedcomGo' do |medcomGo|
    ...
    medcomGo.dependency 'ApplicasterSDK', '~> 7.1.0'
  end
  ...
  s.subspec 'Jpost' do |jpost|
    ...
    jpost.dependency 'ApplicasterSDK', '~> 7.1.0'
  end
  ...
  s.subspec 'CloudPass' do |cloudPass|
    ...
    cloudPass.dependency 'ApplicasterSDK', '~> 7.1.0'
  end
