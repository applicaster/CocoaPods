Pod::Spec.new do |s|
  ...
  s.source = {
      "http" => "https://dl.bintray.com/applicaster-ltd/pods/ZappLoginPlugins_Framework_2.7.12_f69125602177f29b7584bb615b611c8733a5ae9d.zip"
  }
  ...
  s.subspec 'CloudPass' do |cloudPass|
    cloudPass.public_header_files = 'ZappLoginPluginCloudPass/**/*.h'
    cloudPass.source_files = 'ZappLoginPluginCloudPass/**/*.{h,m,swift}'

    cloudPass.resources = [
      "ZappLoginPluginCloudPass/**/*.{png,xib}"
    ]
