Pod::Spec.new do |s|
  ...
  s.source = {
      "http" => "https://dl.bintray.com/applicaster-ltd/pods/ZappAnalyticsPlugins_Framework_2.9.0_59159d4000d65e4ff91a31ddca4ccefbbb4d6cc3.zip"
  }
  ...
  s.subspec 'Mixpanel' do |mixpanel|
    ...
    mixpanel.dependency 'Mixpanel-swift', '~> 2.3.0'
  end
  ...
  s.subspec 'Agof' do |agof|
    ...
    agof.dependency 'INFOnlineLibrary', '~> 2.0.0'
  ...
  s.subspec 'Firebase' do |firebase|
     ...
     firebase.dependency 'Firebase', '~> 4.5.0'
