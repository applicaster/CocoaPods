Pod::Spec.new do |s|
  ...
  s.source = {
      "http" => "https://dl.bintray.com/applicaster-ltd/pods/ZappAnalyticsPlugins_Framework_3.1.8_b496aea0b323e9b795ba142d1adc3cc796ccfa0a.zip"
  }
  ...
  s.subspec 'Mixpanel' do |mixpanel|
    ...
    mixpanel.dependency 'Mixpanel-swift', '= 2.4.4'
  end
