Pod::Spec.new do |s|
	...
	s.source       = {
                     "http" => "https://dl.bintray.com/applicaster-ltd/pods/ZappLayoutsComponentsSDK_Framework_1.9.0_0acf1fc2672d9f5e823dc876fdd3d5bfcfc89ee2.zip"
  }
	...
	s.dependency 'ComponentsSDK', '~> 4.20.0'
