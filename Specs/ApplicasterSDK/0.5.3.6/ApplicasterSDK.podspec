Pod::Spec.new do |s|
	...
	s.source = {
		"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_0.5.3.6_4ec9cde1ea54a6b1c9df231e33497b0d86836ea0.zip"
	}
	...
	s.xcconfig = {
		...
		'OTHER_LDFLAGS' => '$(inherited) -objc -l"AdManager" -framework "AFNetworking" -framework "AppoxeeSDK" -framework "GoogleMobileAds" -framework "HockeySDK" -framework "GoogleInteractiveMediaAds"',
		'ENABLE_BITCODE' => 'NO',
