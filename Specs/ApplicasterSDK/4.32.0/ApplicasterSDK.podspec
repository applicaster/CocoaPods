Pod::Spec.new do |s|
	...
	s.source = {
		"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_4.32.0_4af10a14ce65b556114cc95539c945571fc2dc2e.zip"
	}
	...
	s.dependency 'ZappPlugins', '~> 1.20.0'
