Pod::Spec.new do |s|
	...
	s.source = {
		"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_4.27.1_fdb9dfda5375ae2a148ce75d7a388a24f227a452.zip"
	}
	...
	s.dependency 'ZappPlugins', '~> 1.18.0'
