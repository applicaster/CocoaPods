Pod::Spec.new do |s|
	...
	s.ios.deployment_target = "8.0"
		...
		s.source = {
      	"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_3.1.10_791e0bfbc73b33c4369619c353164b11e66856ba.zip"
  	}
	  ...
	  s.dependency 'Firebase/AdMob', '~> 3.3.0'
		...
		s.dependency 'ZappPlugins', '~> 0.6.0'
