Pod::Spec.new do |s|
	...
	s.source = {
		"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_7.3.10_a83c399e0a4a50539f87198afc63f41226159360.zip"
	}
...
# s.static_framework = true
	...
	s.dependency 'ZappAnalyticsPluginsSDK', '~> 5.2.0'
	s.dependency 'ZappPushPluginsSDK', '~> 5.2.0'
	s.dependency 'ZappLoginPluginsSDK', '~> 5.2.0'
