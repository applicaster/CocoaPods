Pod::Spec.new do |s|
	...
	s.source = {
		"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_8.4.3_255bcea54d8e0b5949e5db9cf9ad9bba916384d4.zip"
	}
...
# s.static_framework = true
	...
	s.dependency 'ZappPlugins', '~> 7.4.0'
	s.dependency 'ZappAnalyticsPluginsSDK', '~> 6.4.0'
	s.dependency 'ZappPushPluginsSDK', '~> 6.0.0'
	s.dependency 'ZappLoginPluginsSDK', '~> 6.1.0'
	s.dependency 'ZappGeneralPluginsSDK', '~> 6.3.0'
end
