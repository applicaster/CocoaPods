Pod::Spec.new do |s|
	...
	s.source = {
		"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_11.0.0_7297fc9c54df0050ce0e29f94a40f4deb6512151.zip"
	}
...
# s.static_framework = true
  ...
  s.dependency 'TwitterKit', '= 3.4.2'
	...
	s.dependency 'ZappPushPluginsSDK', '~> 9.0.0'
	s.dependency 'ZappLoginPluginsSDK', '~> 9.0.0'
