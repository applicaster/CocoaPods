Pod::Spec.new do |s|
	...
	s.source = {
		"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_7.3.2_ba79b463f8fe4a82d283600a7cb55e65dbb63fbb.zip"
	}
...
# s.static_framework = true
	...
	s.dependency 'ZappPushPluginsSDK', '~> 5.1.0'
	s.dependency 'ZappLoginPluginsSDK', '~> 5.1.0'
