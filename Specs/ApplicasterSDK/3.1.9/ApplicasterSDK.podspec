Pod::Spec.new do |s|
	...
	s.ios.deployment_target = "8.0"
		...
		s.source = {
      	"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_3.1.9_26d49a080c2bc800d2b317023b3efd0b383ef328.zip"
  	}
	  ...
	  s.dependency 'Firebase/AdMob', '~> 3.3.0'
		...
		s.dependency 'ZappPlugins', '~> 0.5.0'
