Pod::Spec.new do |s|
	...
	s.ios.deployment_target = "8.0"
		...
		s.source = {
      	"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_4.1.7_1e36cca9c0f1787d93add09e2d2d73e4e242947b.zip"
  	}
		...
		s.dependency 'ZappPlugins', '~> 1.1.0'
		...
		# Integration ONLY
		s.dependency 'ZappAnalyticsPlugins/Flurry','~> 1.1.0'
end
