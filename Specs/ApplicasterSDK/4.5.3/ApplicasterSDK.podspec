Pod::Spec.new do |s|
	...
	s.ios.deployment_target = "8.0"
		...
		s.source = {
      	"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_4.5.3_021f20a5bc1a67b7e6c0ec7cf36697db0fcc5e90.zip"
  	}
		...
		# Integration ONLY
		s.dependency 'ZappAnalyticsPlugins/Flurry','~> 1.8.0'
end
