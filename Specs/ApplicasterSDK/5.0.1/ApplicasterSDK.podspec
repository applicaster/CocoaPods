Pod::Spec.new do |s|
	...
	s.source = {
		"http" => "https://dl.bintray.com/applicaster-ltd/pods/ApplicasterSDK_Framework_5.0.1_166fd8bb6ecab7e50325ffd4311b23453ffcad57.zip"
	}
	...
	s.xcconfig = {
		...
		'OTHER_LDFLAGS' => '$(inherited) -objc -l"AdManager" -framework "AppoxeeSDK" -framework "GoogleMobileAds" -framework "HockeySDK" -framework "GoogleInteractiveMediaAds" -framework "TwitterKit" -framework "TwitterCore"',
		'ENABLE_BITCODE' => 'NO',
	...
	# Public frameworks
	s.dependency 'AFSessionOperation', '1.0.9'
	...
	s.dependency 'ZappPlugins', '~> 2.0.1'
	...
	s.dependency 'ZappAppConnector', '~> 2.0.2'
