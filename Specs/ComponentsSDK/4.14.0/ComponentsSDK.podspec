Pod::Spec.new do |s|
	...
	s.source = {
			"http" => "https://dl.bintray.com/applicaster-ltd/pods/ComponentsSDK_Framework_4.14.0_199b86c9d686d106ef04f5f8b23b7c36582dce2f.zip"
	}
	...
	s.dependency 'ApplicasterSDK', '~> 4.18.0'
	s.dependency 'ApplicasterUIKit', '~> 1.5.0'
	s.dependency 'ZappPlugins', '~> 1.15.0'
