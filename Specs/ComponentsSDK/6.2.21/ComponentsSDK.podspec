Pod::Spec.new do |s|
	...
	s.source = {
			"http" => "https://dl.bintray.com/applicaster-ltd/pods/ComponentsSDK_Framework_6.2.21_44c065fa09706b85b5fcaed383befcb248f97341.zip"
	}
	...
	s.dependency 'ApplicasterSDK', '~> 6.4.8'
