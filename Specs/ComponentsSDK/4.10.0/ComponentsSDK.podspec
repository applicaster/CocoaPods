Pod::Spec.new do |s|
	...
	s.source = {
			"http" => "https://dl.bintray.com/applicaster-ltd/pods/ComponentsSDK_Framework_4.10.0_3c2d1a3a0a438f1ac195d13737b337f7692b4ffb.zip"
	}
	...
	s.dependency 'ApplicasterSDK', '~> 4.11.0'
