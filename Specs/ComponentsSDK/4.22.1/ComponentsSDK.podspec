Pod::Spec.new do |s|
	...
	s.source = {
			"http" => "https://dl.bintray.com/applicaster-ltd/pods/ComponentsSDK_Framework_4.22.1_9b33aff477ea88ce243856ae1b6818cf49f28d48.zip"
	}
	...
	s.dependency 'ApplicasterSDK', '~> 4.27.0'
