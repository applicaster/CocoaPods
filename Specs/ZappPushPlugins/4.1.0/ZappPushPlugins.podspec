Pod::Spec.new do |s|
  ...
  s.license = 'CMPS'
	...
	s.source = {
      "http" => "https://dl.bintray.com/applicaster-ltd/pods/ZappPushPlugins_Framework_4.1.0_0f89ed1dca4c57cf9af31d5291fc56e2d373baf5.zip"
  }
  ...
  s.subspec 'Basic' do |basic|
    basic.dependency 'ZappPlugins', '~> 6.0.0'
  end
